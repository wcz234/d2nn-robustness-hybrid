...
CLASSIFIER_D2NN2018_THZ_OPTICS = OpticalConfig(
    wavelength=0.75e-3,
    layer_distance=30e-3,
    pixel_size=0.4e-3,
...
CLASSIFICATION_OPTICS_PRESETS = {
    ...
    "d2nn2018_thz": CLASSIFIER_D2NN2018_THZ_OPTICS,
...
CLASSIFICATION_ONLY_OPTICS_PRESETS = frozenset(CLASSIFICATION_OPTICS_PRESETS) - frozenset(IMAGING_OPTICS_PRESETS)
LAB_CLASSIFICATION_OPTICS_PRESETS = frozenset({"lab852_f10", "lab852_f5"})
...
def write_export_report(
    ...
    *,
    ...
    lines = [
        ...
        f"- phase-mask quantization levels: `{'continuous' if phase_quantization_levels is None else phase_quantization_levels}`",
        f"- height-map encoding levels: `{quantization_levels}`",
        "",
        "## Layer Ranges",
        "",
